	...
	this.defaultOptions = {
		...
		'Confirm': {
			...
			_onCreated: function() {
				...
				jQuery('<div class="jBox-Confirm-button jBox-Confirm-button-cancel"/>').html(this.options.cancelButton).click(function() {this.options.onCancel.call(null,this); this.close(); }.bind(this)).appendTo(this.footer);
			...
			_onOpen: function() {
				...
				this.submitButton.off('click.jBox-Confirm' + this.id).on('click.jBox-Confirm' + this.id, function() {
                    if(this.options.onSubmit){
                        if(!this.isLoading){this.options.onSubmit.call(null,this);}
...
jBox.prototype.loading = function() {
    this.wrapper.addClass('jBox-loading');
	this.isLoading = true;
	return this;
};

jBox.prototype.unloading = function() {
    this.wrapper.removeClass('jBox-loading');
